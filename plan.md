...
| **M2 CSS 完整化 + 动画 + 主题** | 完整 Selector/Cascade/Specificity/Var/Inheritance/Pseudo/Animation；Theme 系统；Animation 模块 | CSS, Animation, UI | CSS 测试套件通过；主题切换与 CSS 动画可运行 |
| **M3 扩展控件** | List/Tree/Menu/Dialog/ScrollViewer/Grid/Popup/Window/Tab/Swiper/Navigator | Controls, Layout, Platform | 各控件可交互、可滚动、可组合 |
