...
public class GutterDecorationTests
{
    ...
    public void RemoveAndClearDecorations_UpdateCount()
    {
        ...
        pad.SetDecorations(
        [
            new CodeEditorLineDecoration { Id = "a", Line = 0, Glyph = "●" },
            new CodeEditorLineDecoration { Id = "b", Line = 1, GutterColor = Color.FromRgb(1, 2, 3) },
        ]);
        Assert.Equal(2, pad.DecorationCount);
    ...
    public void GutterClick_OnGlyphMargin_RaisesEvent_WithLineAndLane()
    {
        ...
        CodeEditorGutterClickEventArgs? args = null;
        ...
        Assert.NotNull(args);
        Assert.Equal(CodeEditorGutterLane.Glyph, args!.Lane);
