...
public class CaretBlinkTests
{
    ...
    {
        var pad = new CodeEditor { Geometry = new Rect(0, 0, 200, 100), Value = "hi" };
    ...
    {
        var pad = new CodeEditor { Geometry = new Rect(0, 0, 200, 100), Value = "ab" };
        pad.Focus();
        pad.ResetCaretBlink();
    ...
    {
        var pad = new CodeEditor { Geometry = new Rect(0, 0, 200, 100), Value = "abcd" };
        pad.Focus();
        pad.SelectAll();
