...
/// </summary>
public sealed class CodePadLineDecoration
{
...
public sealed class CodePadGutterClickEventArgs : EventArgs
{
    /// <summary>初始化。</summary>
    public CodePadGutterClickEventArgs(int line, Point point, CodePadGutterLane lane)
    {
        Line = line;
        Point = point;
        Lane = lane;
    ...
    public CodePadGutterLane Lane { get; }
}

/// <summary>左侧 gutter 列。</summary>
public enum CodePadGutterLane
{
