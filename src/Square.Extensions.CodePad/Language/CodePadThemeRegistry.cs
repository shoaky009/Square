...
public static class CodePadThemeRegistry
{
    private static readonly object Gate = new();

    private static readonly Dictionary<string, CodePadTheme> Themes =
        new(StringComparer.OrdinalIgnoreCase);

    private static bool _builtIns;

    /// <summary>注册主题。</summary>
    public static void Register(string id, CodePadTheme theme)
    {
    ...
    public static CodePadTheme Get(string? id)
    {
        EnsureBuiltIns();
        lock (Gate)
        {
    ...
    private static CodePadTheme CreateLight() => new()
    {
    ...
    private static CodePadTheme CreateDark() => new()
    {
...
/// <summary>CodePad 主题。</summary>
public sealed class CodePadTheme
{
